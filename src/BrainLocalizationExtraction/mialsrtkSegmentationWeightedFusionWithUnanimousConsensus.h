...
==========================================================================*/
#ifndef mialsrtkSEGMENTATIONWEIGHTEDFUSIONWITHUNANIMOUSCONSENSUS_H
  #define mialsrtkSEGMENTATIONWEIGHTEDFUSIONWITHUNANIMOUSCONSENSUS_H
#endif
...
#define MAX_CHAR_LENGTH  100
  ...
  const std::string intermediateSaveDirectory = "/home/ch176971/Desktop/Debug/";
  ...
  //////////////////////////////////////////////////////////
    ...
    typedef itk::MaskImageFilter<InputImageType,InputImageType,InputImageType> ImageMaskFilterType;
...
void unConsensusVoting(std::vector<float> & values, double & outputConsensusValue, double & outputMaskValue);
