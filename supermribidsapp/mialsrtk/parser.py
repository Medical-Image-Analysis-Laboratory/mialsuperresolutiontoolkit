...
""" MIAL Super-Resolution MRI BIDS App Commandline Parser
"""
...
def get():
    import argparse
    p = argparse.ArgumentParser(description='Super Resolution BIDS App entrypoint script.')
    ...
    p.add_argument('--pipeline_config', help='Configuration .txt file for processing stages of the super-resolution MRI pipeline')

    # p.add_argument('--skip_bids_validator', help='Whether or not to perform BIDS dataset validation',
    #                    action='store_true')
    p.add_argument('-v', '--version', action='version',
                        version='Super Resolution BIDS App version {}'.format(__version__))
    return p
