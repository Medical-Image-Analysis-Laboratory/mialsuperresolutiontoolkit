# -*- coding: utf-8 -*-
#
# CMA documentation build configuration file, created by
# sphinx-quickstart on Fri Mar 15 10:49:53 2013.
#
...
project = "Medical Image Analysis Laboratory Super-Resolution Toolkit"
copyright = (
    "2016-{}, Medical Image Analysis Laboratory (MIAL) & Contributors".format(
        time.strftime("%Y")
    )
)
...
.. |vrelease| replace:: {}
""".format(
    f"pymialsrtk=={release}", f"v{release}"
)
...
html_short_title = "MIALSRTK"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "images/mialsrtk-logo.png"
