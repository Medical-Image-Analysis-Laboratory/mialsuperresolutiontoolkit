...
class AnatomicalPipeline:
    ...
    #         open(os.path.join(self.output_dir,"pypeline.log"), 'a').close()
        ...
        if self.use_manual_masks:
            ...
            brainMask.inputs.in_ckpt = pkg_resources.resource_filename("pymialsrtk", "data/Network_checkpoints/Unet.ckpt-88000")
    ...
    #     self.wf.connect(dg, "masks", nlmDenoise, "input_masks")  ## Comment to match docker process
        ...
        for stack in self.p_stacksOrder:
            ...
            print( sub_ses+'_run-'+str(stack)+'_T2w_nlm_uni_bcorr_histnorm.nii.gz', '    --->     ',sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_desc-preprocSDI_T2w.nii.gz')
            substitutions.append( ( sub_ses+'_run-'+str(stack)+'_T2w_nlm_uni_bcorr_histnorm.nii.gz', sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_desc-preprocSDI_T2w.nii.gz') )

            print( sub_ses+'_run-'+str(stack)+'_T2w_nlm_uni_bcorr_histnorm.nii.gz', '    --->     ',sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_desc-preprocSR_T2w.nii.gz')
            substitutions.append( ( sub_ses+'_run-'+str(stack)+'_T2w_uni_bcorr_histnorm.nii.gz', sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_desc-preprocSR_T2w.nii.gz') )
            
            print( sub_ses+'_run-'+str(stack)+'_T2w_nlm_uni_bcorr_histnorm_transform_'+str(len(self.p_stacksOrder))+'V.txt', '    --->     ', sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_T2w_from-origin_to-SDI_mode-image_xfm.txt')
            substitutions.append( ( sub_ses+'_run-'+str(stack)+'_T2w_nlm_uni_bcorr_histnorm_transform_'+str(len(self.p_stacksOrder))+'V.txt', sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_T2w_from-origin_to-SDI_mode-image_xfm.txt') )
            
            print( sub_ses+'_run-'+str(stack)+'_T2w_uni_bcorr_histnorm_LRmask.nii.gz', '    --->     ', sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_T2w_desc-brain_mask.nii.gz')
            substitutions.append( ( sub_ses+'_run-'+str(stack)+'_T2w_uni_bcorr_histnorm_LRmask.nii.gz', sub_ses+'_run-'+str(stack)+'_id-'+str(self.srID)+'_T2w_desc-brain_mask.nii.gz') )

            
        print( 'SDI_'+sub_ses+'_'+str(len(self.p_stacksOrder))+'V_rad1.nii.gz', '    --->     ', sub_ses+'_rec-SDI'+'_id-'+str(self.srID)+'_T2w.nii.gz')
        substitutions.append( ( 'SDI_'+sub_ses+'_'+str(len(self.p_stacksOrder))+'V_rad1.nii.gz', sub_ses+'_rec-SDI'+'_id-'+str(self.srID)+'_T2w.nii.gz') )

        print( 'SRTV_'+sub_ses+'_'+str(len(self.p_stacksOrder))+'V_rad1_gbcorr.nii.gz', '    --->     ', sub_ses+'_rec-SR'+'_id-'+str(self.srID)+'_T2w.nii.gz')
        substitutions.append( ( 'SRTV_'+sub_ses+'_'+str(len(self.p_stacksOrder))+'V_rad1_gbcorr.nii.gz', sub_ses+'_rec-SR'+'_id-'+str(self.srID)+'_T2w.nii.gz') )
        
        print( sub_ses+'_T2w_uni_bcorr_histnorm_srMask.nii.gz', '    --->     ', sub_ses+'_rec-SR'+'_id-'+str(self.srID)+'_T2w_desc-brain_mask.nii.gz')
        substitutions.append( ( sub_ses+'_T2w_uni_bcorr_histnorm_srMask.nii.gz', sub_ses+'_rec-SR'+'_id-'+str(self.srID)+'_T2w_desc-brain_mask.nii.gz') )
