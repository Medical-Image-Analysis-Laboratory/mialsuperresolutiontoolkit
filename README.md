...
A Docker image is provided to facilitate the deployment and freely available on the [Docker store](https://store.docker.com/community/images/sebastientourbier/mialsuperresolutiontoolkit).  
...
* FOR USERS: [How to run Docker image](https://github.com/sebastientourbier/mialsuperresolutiontoolkit/blob/master/documentation/userguide_docker.md)
